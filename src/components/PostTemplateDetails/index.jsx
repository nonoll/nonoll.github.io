...
import AdSense from 'react-adsense'; // https://www.npmjs.com/package/react-adsense
      ...
      <div>
        ...
        <div className="post-single">
          <div className="post-single__inner">
            ...
            <AdSense.Google
              client='ca-pub-2365531018407022'
              slot='3390644000'
              style={{ display: 'block' }}
          ...
          <div className="post-single__footer">
            ...
            <p className="post-single__footer-text">
              {subtitle}
              {
                author.twitter ? <a href={`https://twitter.com/${author.twitter}`} target="_blank" rel="noopener noreferrer">
